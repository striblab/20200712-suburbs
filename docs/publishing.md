...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/precincts">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/precincts/styles.bundle.css`
      * `scripts`: `news/projects/all/precincts/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/precincts/",
      "url": "http://static.startribune.com/news/projects-staging/all/precincts/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/precincts/",
      "url": "http://static.startribune.com/news/projects/all/precincts/"
    }
  }
}
```
